...
class PaletteList extends Component {
  ...
  handleDelete() {
    this.props.firebase.db
      .collection("defeaultpalettes")
      .doc(this.state.operationId)
      .delete()
      .then(() => {
        this.setState({
    ...
    return (
      <div className={classes.root}>
        <div className={classes.container}>
          <Navbar
            authUser={authUser}
            toggleSignInDialog={this.toggleSignInDialog}
          />
        ...
        >
          ...
          <List>
            ...
            <ListItem button onClick={this.toggleSignInDialog}>
              <ListItemAvatar>
                <Avatar
                  style={{ backgroundColor: grey[100], color: grey[600] }}
                >
                  <CloseIcon />
                </Avatar>
              </ListItemAvatar>
